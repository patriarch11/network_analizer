...
NetTrafficMonitor = Generator[NetTraffic, None, None]
NetIfStatsMonitor = Generator[list[NetIfStats], None, None]
NetIfConnectionsMonitor = Generator[list[NetIfConnections], None, None]
...
class NetObserver:
    ...
    def connections_monitor(self) -> NetIfConnectionsMonitor:
        while True:
    ...
    def stats_monitor(self) -> NetIfStatsMonitor:
        while True:
    ...
    def traffic_monitor(self) -> NetTrafficMonitor:
